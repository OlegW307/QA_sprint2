class BooksCollector:
    ...
    def __init__(self): #  при создании экземпляра создается шаблон коллекции
        self.books_rating = {} #  словарь для рейтинга
        self.favorites = [] #  список для любимых книг
...
mybooks = BooksCollector()
mybooks.add_new_book('Молодая гвардия')
mybooks.set_book_rating('Молодая гвардия', 8)
print(mybooks.get_books_rating())
